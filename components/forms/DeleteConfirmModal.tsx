  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative w-full max-w-md rounded-3xl bg-white border border-[#EAE3D6] p-6 sm:p-7 shadow-2xl z-10 animate-in zoom-in-95 fade-in duration-200"
      >
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-11 h-11 rounded-2xl bg-red-50 border border-red-200 flex items-center justify-center text-red-600">
          ...
          <div className="flex-1 min-w-0">
            <h3
              ...
              className="text-base font-semibold text-[#1C1917] leading-snug font-serif-editorial text-lg"
            >
        ...
        {/* Modal Actions */}
        <div className="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-[#EAE3D6]">
          <Button
            variant="outline"
            size="sm"
            onClick={onCancel}
