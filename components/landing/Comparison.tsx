    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 max-w-5xl mx-auto">
          ...
          <div className="comparison-card bg-[#FAF8F5] rounded-3xl p-7 sm:p-9 border border-[#EAE3D6] card-shadow flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between pb-6 border-b border-[#EAE3D6]">
                <div>
                  ...
                  <h3 className="font-serif-editorial text-2xl sm:text-3xl text-[#57534E] font-medium mt-1">
                    Generic Form Builders
                  </h3>
                </div>
                <div className="w-10 h-10 rounded-2xl bg-white border border-[#EAE3D6] flex items-center justify-center text-[#A8A29E]">
              ...
              <div className="mt-6 space-y-4">
                {genericCons.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-[#A8A29E] shrink-0 mt-0.5" />
                    <span className="text-sm text-[#78716C] leading-snug">
                      {item}
                    </span>
                  </div>
                ))}
            ...
            <div className="mt-8 pt-5 border-t border-[#EAE3D6] text-xs text-[#A8A29E] font-medium text-center">
              Leads to high drop-off rates & respondent fatigue
            </div>
          </div>

          {/* Card 2: InstantForm */}
          <div className="comparison-card bg-[#FFFDFC] rounded-3xl p-7 sm:p-9 border-2 border-[#FF5A36] shadow-xl shadow-[#FF5A36]/5 flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              <div className="flex items-center justify-between pb-6 border-b border-[#FFD8CC]">
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-[#FF5A36]">
                    The Modern Standard
                  </span>
                  <h3 className="font-serif-editorial text-2xl sm:text-3xl text-[#1C1917] font-medium mt-1">
                    InstantForm
                  </h3>
                </div>
                <div className="w-10 h-10 rounded-2xl bg-[#FFF0EB] border border-[#FFD8CC] flex items-center justify-center text-[#FF5A36]">
              ...
              <div className="mt-6 space-y-4">
                {instantFormPros.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-sm font-medium text-[#1C1917] leading-snug">
                      {item}
                    </span>
                  </div>
                ))}
            ...
            <div className="mt-8 pt-5 border-t border-[#FFD8CC] flex items-center justify-between">
              <span className="text-xs font-bold text-[#FF5A36] bg-[#FFF0EB] px-3 py-1 rounded-full">
