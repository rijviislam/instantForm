  ...
  return (
    <div className="flex flex-col gap-2.5 w-full mb-6">
      ...
      <button
        ...
        className="w-full inline-flex items-center justify-center gap-3 py-2.5 px-4 rounded-full bg-white hover:bg-[#F4EFE6]/50 active:scale-[0.99] border border-[#E7E2D8] hover:border-[#D8D0C0] text-[#1C1917] text-sm font-medium transition-all shadow-2xs cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
      ...
      >
        {loadingProvider === "github" ? (
          ...
          <svg className="w-4 h-4 shrink-0 fill-current text-[#1C1917]" viewBox="0 0 24 24">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
