          ...
          {faqs.map((faq) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-serif-editorial text-lg sm:text-xl text-[#1C1917] font-medium leading-snug">
                    {faq.question}
                  </span>
                  <div
                    className={clsx(
                      ...
                      isOpen
                        ? "bg-[#FFF0EB] border-[#FFD8CC] text-[#FF5A36] rotate-180"
                ...
                {isOpen && (
                  <div className="px-5 pb-6 sm:px-6 sm:pb-6 text-sm text-[#57534E] leading-relaxed border-t border-[#FAF8F5] animate-in fade-in duration-200">
